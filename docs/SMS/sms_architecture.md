...
At a high level, the Equify SMS architecture consists of three logical domains:

| Domain | Description |
|------------|-------------|
| Client System | Generates communication requests through database and API and receives delivery status updates |
